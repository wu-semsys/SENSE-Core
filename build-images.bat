...
@REM remove the images if they already exist
docker image rm sense-core/data-ingestion:v1.0 2> NUL
docker image rm sense-core/event-to-state-causality:v1.0 2> NUL
docker image rm sense-core/explanation-interface:v1.0 2> NUL
docker image rm sense-core/knowledgebase:v1.0 2> NUL
docker image rm sense-core/semantic-event-log-bridge:v1.0 2> NUL
docker image rm sense-core/simple-event-detection:v1.0 2> NUL
